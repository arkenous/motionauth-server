...
#ifndef MOTIONAUTH_SERVER_NEURON_H
#define MOTIONAUTH_SERVER_NEURON_H
...
public:
  ...
  unsigned long getNumInput();
  double getInputWeightIndexOf(const unsigned long i);
  double getDelta();
  double getBias();
  double getMIndexOf(const unsigned long i);
  double getNuIndexOf(const unsigned long i);
...
#endif //MOTIONAUTH_SERVER_NEURON_H
